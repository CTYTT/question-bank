...
//        System.out.println("请输入文件输出目录的模块或者项目的地址:");
        String projectPath = "F:\\practiceWorkspace\\OCR";
        gc.setOutputDir( "F:\\practiceWorkspace\\OCR\\src\\main\\java");      //生成文件的输出目录
        gc.setAuthor("nanan");                                  //作者
...
//        String tables = "t_audit_rule,t_audit_script_ctg,t_audit_task,t_audit_task_attr,t_audit_type_ctg,mm_entity_spec,mm_spec_attribute";
        String tables = "question_bank";
        String[] num = tables.split(",");
        strategy.setInclude(num);                       // 需要生成的表可以多张表
//	    strategy.setExclude(new String[]{"test"});      // 排除生成的表
//如果数据库有前缀，生成文件时是否要前缀acl_
        strategy.setTablePrefix("t_");
        strategy.setTablePrefix("mm_");//表前缀
